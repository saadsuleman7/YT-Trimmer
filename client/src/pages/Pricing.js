...
const Pricing = () => {
  ...
  const paidPlans = [
    ...
    { id: '3months', name: '3 Months', price: '$7', period: '/3 mo', monthly: '$2.33/mo', save: '46%' },
    { id: '6months', name: '6 Months', price: '$12', period: '/6 mo', monthly: '$2/mo', save: '54%' },
    { id: 'yearly', name: 'Yearly', price: '$20', period: '/year', monthly: '$1.67/mo', save: '61%', best: true },
  ];
          ...
          <div className="card p-8 border-2 border-primary-500 shadow-glow h-full relative">
            ...
            <div className="text-center mb-6">
              ...
              <div className="flex items-end justify-center">
                ...
                <span className="text-gray-500 dark:text-gray-400 ml-1 mb-1">- $20</span>
              </div>
