      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <AnimateIn type="fade-up" delay={150}>
            ...
            <AnimateIn type="fade-up" delay={450}>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link to="/tool" className="btn-primary text-lg px-8 py-3.5 flex items-center space-x-2 hover:scale-105 transition-transform">
                  <span>Start Trimming</span>
                  <FiArrowRight />
                </Link>
                <Link to="/pricing" className="btn-outline text-lg px-8 py-3.5 hover:scale-105 transition-transform">
                  View Plans
                </Link>
              </div>
            </AnimateIn>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, i) => (
              <AnimateIn key={i} type="fade-up" delay={i * 120}>
                <div className="card-hover p-6 text-center h-full">
                  <div className="inline-flex items-center justify-center w-14 h-14 bg-primary-100 dark:bg-primary-900/30 text-primary-600 rounded-2xl mb-4 animate-float" style={{ animationDelay: `${i * 0.5}s` }}>
                    {feature.icon}
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <AnimateIn key={i} type="scale" delay={i * 150}>
                <div className="text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-primary rounded-2xl text-dark-900 text-2xl font-bold mb-4 shadow-glow animate-float" style={{ animationDelay: `${i * 0.8}s` }}>
                    {item.step}
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <AnimateIn type="fade-left" delay={200}>
              <div className="card p-8 border-2 border-primary-500 relative h-full">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <AnimateIn type="scale">
            <div className="card p-8 sm:p-12 bg-gradient-to-r from-indigo-600 to-purple-600 border-none text-white">
              <FaDiscord size={48} className="mx-auto mb-4 opacity-80 animate-float" />
              ...
              <a
                ...
                className="inline-flex items-center space-x-2 bg-white text-indigo-600 font-semibold px-8 py-3 rounded-xl hover:bg-gray-100 hover:scale-105 transition-all"
              >
                <FaDiscord size={20} />
